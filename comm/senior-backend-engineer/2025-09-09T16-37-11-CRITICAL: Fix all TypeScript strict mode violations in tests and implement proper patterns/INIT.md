# CRITICAL: Fix All TypeScript Strict Mode Violations in Tests
...
**CRITICAL**: Do not create any new test files until you understand and apply these patterns correctly!
